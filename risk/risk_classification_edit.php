...
<? echo "						<input type=\"text\" name=\"risk_classification_type_new\" id=\"risk_classification_criteria_new\" value=\"\"/>";?>
						<label for="name">Name</label>
						<span class="description">You will need to create a name for your classification. Examples could be "High", "Low", etc.</span>
<? echo "						<input type=\"text\" name=\"risk_classification_name\" id=\"risk_classification_name\" value=\"$risk_classification_item[risk_classification_name]\"/>";?>
...
<? echo "						<textarea name=\"risk_classification_criteria\">$risk_classification_item[risk_classification_criteria]</textarea>";?>
...
<? echo "						<input type=\"text\" name=\"risk_classification_value\" id=\"risk_classification_value\" value=\"$risk_classification_item[risk_classification_value]\"/>";?>
