...
<?
echo "						<textarea id=\"\" name=\"risk_threat\">$risk_item[risk_threat]</textarea>";
?>
...
<?
echo "						<input type=\"text\" name=\"risk_classification_score\" id=\"\" value=\"$risk_item[risk_classification_score]\"/>";
?>
...
<?
echo "						<input type=\"text\" name=\"risk_residual_score\" id=\"\" value=\"$risk_item[risk_residual_score]\"/>";
?>
...
?>
						...
						<span class="description">At regular intervals, this risk will need to be reviewed for updates. Default is 12 months.</span>
<?
echo "						<input type=\"text\" name=\"risk_periodicity_review\" id=\"\" value=\"$risk_item[risk_periodicity_review]\"/>";
?>
