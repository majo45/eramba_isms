<?
	...
	if ($action == "update" & is_numeric($risk_classification_id)) {
		...
		add_system_records("risk","risk_classification","$risk_classification_id","","Update","");
		...
		add_risk_classification($risk_classification_update);
		add_system_records("risk","risk_classification","$risk_classification_id","","Insert","");
	}

	if ($action == "disable") {
		disable_risk_classification($risk_classification_id);
		add_system_records("risk","risk_classification","$risk_classification_id","","Disable","");
	}

	if ($action == "csv") {
		export_risk_classification_csv();
		add_system_records("risk","risk_classification","$risk_classification_id","","Export","");
	}
