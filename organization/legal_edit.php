...
<? echo "						<input type=\"text\" name=\"legal_name\" id=\"legal_name\" value=\"$legal_item[legal_name]\"/>";?>
						
						<label for="description">Description</label>
						<span class="description">Describe what this legal constrain is about so everyone understands.</span>
<? echo "						<textarea name=\"legal_description\">$legal_item[legal_description]</textarea>";?>
				</div>
