...
<? echo "						<input type=\"text\" name=\"process_name\" id=\"process_name\" value=\"$process_item[process_name]\"/>";?>
						
						<label for="description">Description</label>
						<span class="description">Give a brief description of what the Process does, so everyone is in the same page.</span>
<? echo "						<textarea name=\"process_description\">$process_item[process_description]</textarea>";?>
						<label for="name">Process Recovery Time Objective (RTO)</label>
						<span class="description">Right. This question will be useful at the time of preparing your Business Continuity Management (BCM) program. You need to provide a number of days, which this process could be completly stopped before it causes great disruption to the organization. Example: 1, 4, 6 (do not write anything else than a integer number). Default RTO is 360 Days.</span>
<? echo "						<input type=\"text\" name=\"process_rto\" id=\"process_rto\" value=\"$process_item[process_rto]\"/>";?>
				</div>
