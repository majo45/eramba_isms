...
<? echo "						<input type=\"text\" name=\"asset_classification_type_new\" id=\"asset_classification_criteria_new\" value=\"\"/>";?>
						<label for="name">Name</label>
						<span class="description">You will need to create a name for your classification. Examples could be "High", "Low", etc.</span>
<? echo "						<input type=\"text\" name=\"asset_classification_name\" id=\"asset_classification_name\" value=\"$asset_classification_item[asset_classification_name]\"/>";?>
...
<? echo "						<input type=\"text\" name=\"asset_classification_value\" id=\"asset_classification_value\" value=\"$asset_classification_item[asset_classification_value]\"/>";?>
