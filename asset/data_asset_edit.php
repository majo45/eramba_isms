<?
	...
	if (is_numeric($data_asset_id)) {
		...
		$asset_item = lookup_asset("asset_id",$data_asset_item[data_asset_id]);
	} elseif ($asset_id) {
...
<? echo "						<input disabled type=\"text\" name=\"asset_name\" id=\"asset_name\" value=\"$asset_item[asset_name]\"/>";?>
...
<? echo "						<textarea disabled name=\"asset_description\">$asset_item[asset_description]</textarea>";?>
...
<? echo "						<textarea name=\"data_asset_description\">$data_asset_item[data_asset_description]</textarea>";?>
