...
echo "						&nbsp;|&nbsp;";
echo "						<a class=\"delete\" href=\"?action=edit&section=system&subsection=system_records&system_records_lookup_section=asset&system_records_lookup_subsection=asset_identification&system_records_lookup_item_id=$asset_item[asset_id]\">add a note</a>";
echo "					</span>";
