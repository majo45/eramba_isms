...
<? echo "						<textarea name=\"system_records_notes\"></textarea>";?>
				</div>
		...
		<div class="controls-wrapper">
				    ...
				    <INPUT type="hidden" name="subsection" value="system_records">
<?
echo "\n";
...
echo "				    <INPUT type=\"hidden\" name=\"system_records_lookup_author\" value=\"TBD\"\n";
?>
