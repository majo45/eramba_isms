<?
	...
	if ($action == "update" & is_numeric($security_incident_classification_id)) {
		...
		add_system_records("risk","security_incident_classification","$security_incident_classification_id","","Update","");
	} elseif ($action == "update") {
		$security_incident_classification_update = array(
			'security_incident_classification_name' => $security_incident_classification_name,
			'security_incident_classification_criteria' => $security_incident_classification_criteria,
		);	
		add_security_incident_classification($security_incident_classification_update);
		add_system_records("risk","security_incident_classification","$security_incident_classification_id","","Insert","");
	}

	if ($action == "disable") {
		disable_security_incident_classification($security_incident_classification_id);
		add_system_records("risk","security_incident_classification","$security_incident_classification_id","","Disable","");
	}

	if ($action == "csv") {
		export_security_incident_classification_csv();
		add_system_records("risk","security_incident_classification","$security_incident_classification_id","","Export","");
	}
