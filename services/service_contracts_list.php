<?
	...
	if ($action == "update_service_contracts" & is_numeric($service_contracts_id)) {
		...
		add_system_records("security_catalogue","service_contracts","$service_contracts_id","","Update","");
	...
	if ($action == "disable" & is_numeric($service_contracts_id)) {
		...
		add_system_records("service_contracts","security_catalogue","$service_contracts_id","","Disable","");
	}

	if ($action == "csv") {
		export_service_contracts_csv();
		add_system_records("security_services","security_catalogue","","","Export","");
	}
...
echo "							<td><center>$service_contracts_item[service_contracts_value]</td>";
