...
function export_security_incident_classification_csv() {
	...
	foreach($result as $line) {
		fwrite($handler,"$line[security_incident_classification_id],$line[security_incident_classification_name],$line[security_incident_classification_descripion],$line[security_incident_classification_disabled]\n");
	}
