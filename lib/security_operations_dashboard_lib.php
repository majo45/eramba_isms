...
function security_operations_dashboard_data() {
	...
	$security_operations_dashboard_list = list_security_operations_dashboard(" WHERE MONTH(security_operations_dashboard_date) = $month");
	...
	$security_operations_update = array(
		...
		'security_operations_dashboard_date' => $date
	);	
...
function add_security_operations_dashboard($security_operations_dashboard_data) {
	$sql = "INSERT INTO
		...
		\"$security_operations_dashboard_data[security_operations_dashboard_date]\",
		\"0\"
		)
		";	
