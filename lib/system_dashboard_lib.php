...
function system_dashboard_data() {
	...
	$system_dashboard_list = list_system_dashboard(" WHERE MONTH(system_dashboard_date) = $month");
...
function add_system_dashboard($system_dashboard_data) {
	$sql = "INSERT INTO
		...
		\"$system_dashboard_data[system_dashboard_date]\",
		\"0\"
		)
		";	
